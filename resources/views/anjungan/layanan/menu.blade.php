...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="menu-grid">
            <!-- Loket Pendaftaran -->
            <div class="menu-card loket" onclick="window.location.href='{{ route('anjungan.layanan.loket') }}'">
                <div class="menu-icon">
            ...
            <!-- Customer Service -->
            <div class="menu-card cs" onclick="window.location.href='{{ route('anjungan.layanan.cs') }}'">
                <div class="menu-icon">
            ...
            <!-- Apotek/Farmasi -->
            <div class="menu-card apotek" onclick="window.location.href='{{ route('anjungan.layanan.apotek') }}'">
                <div class="menu-icon">
