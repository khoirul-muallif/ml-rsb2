    ...
    function loadSummary() {
        fetch('/anjungan/api/summary')
            ...
            .then(data => {
                if (data.status) {
                    // Only update Apotek
                    const stats = data.summary['Apotek'];
                    if (!stats) return;
                    
                    const totalEl = document.getElementById('total-Apotek');
                    const menungguEl = document.getElementById('menunggu-Apotek');
                    const nextEl = document.getElementById('next-Apotek');
