...
<head>
    ...
    <title>{{ $title ?? 'Pemanggil Antrian Loket' }}</title>
    ...
    <div class="container-fluid">
        ...
        <div class="text-center mb-5">
            <h1 class="antrian_judul">
                <i class="fa fa-hospital"></i> {{ $title ?? 'Pemanggil Antrian Loket' }}
            </h1>
        </div>
                    ...
                    <div class="mb-5">
                        <div class="panel">
                            ...
                            <div class="panel-heading">
                                <i class="fa fa-door-open"></i> Loket {{ $value }}
                            </div>
                            ...
                            <div class="panel-footer">
                                ...
                                <div class="btn-group-justified mb-3">
                                    ...
                                    <!-- Tombol: Antrian Berikutnya (Forward) -->
                                    <a href="{{ url('/anjungan/pemanggil?show='.$panggil_loket.'&loket='.$value) }}" 
                                       class="btn btn-success btn-custom" title="Panggil antrian berikutnya">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="card-antrian">
                        <h6 class="mb-3" style="color: #666; font-weight: 600;">
                            <i class="fa fa-arrow-right text-success"></i> Lompat ke Nomor Tertentu
                        </h6>
                        <form action="{{ url('/anjungan/pemanggil') }}" method="GET" id="formLompatAntrian">
                            ...
                            <div class="input-group input-group-lg">
                                <input type="text" 
                                       ...
                                       pattern="[0-9]*"
                                       required>
                                <button class="btn btn-success" type="submit" style="font-weight: 600;">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <ul class="instruction-list">
                        <li>
                            <i class="fa fa-forward text-success fa-lg"></i>
                        ...
                        <li>
                            <i class="fa fa-keyboard text-success fa-lg"></i>
