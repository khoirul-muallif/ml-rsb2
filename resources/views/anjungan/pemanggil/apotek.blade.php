...
<head>
    ...
    <title>{{ $title ?? 'Pemanggil Antrian Apotek' }}</title>
    ...
    <div class="container-fluid">
        ...
        <div class="text-center mb-5">
            <h1 class="antrian_judul">
                <i class="fa fa-pills"></i> {{ $title ?? 'Pemanggil Antrian Apotek' }}
            </h1>
        </div>
                    ...
                    <div class="mb-5">
                        <div class="panel">
                            ...
                            <div class="panel-heading">
                                <i class="fa fa-prescription-bottle"></i> Loket {{ $value }}
                            </div>
                            ...
                            <div class="panel-footer">
                                ...
                                <div class="btn-group-justified mb-3">
                                    ...
                                    <a href="{{ url('/anjungan/pemanggil?show='.$panggil_loket.'&loket='.$value) }}" 
                                       class="btn btn-warning btn-custom" title="Panggil antrian berikutnya">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="card-antrian">
                        <h6 class="mb-3" style="color: #666; font-weight: 600;">
                            <i class="fa fa-arrow-right" style="color: #ffc107;"></i> Lompat ke Nomor Tertentu
                        </h6>
                        <form action="{{ url('/anjungan/pemanggil') }}" method="GET" id="formLompatAntrian">
                            ...
                            <div class="input-group input-group-lg">
                                <input type="text" 
                                       ...
                                       pattern="[0-9]*"
                                       required>
                                <button class="btn btn-warning" type="submit" style="font-weight: 600;">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <ul class="instruction-list">
                        <li>
                            <i class="fa fa-forward text-warning fa-lg"></i>
                        ...
                        <li>
                            <i class="fa fa-keyboard text-warning fa-lg"></i>
                            <strong>Form Lompat:</strong> Masukkan nomor untuk loncat ke antrian tertentu
                        </li>
                        <li>
                            <i class="fa fa-barcode text-info fa-lg"></i>
                            <strong>Input RM:</strong> Masukkan nomor rekam medis 6 digit dan klik Simpan. Status otomatis berubah ke Selesai
                        </li>
                    </ul>
                </div>
            </div>
