...
class DisplayAntrianController extends Controller
{
    ...
    public function getDisplay(Request $request)
    {
        ...
        //  AMBIL NOMOR DAN LOKET DARI SETTINGS
        ...
        // PENTING: Gunakan $loketTerkini dari settings, BUKAN dari database
        return response()->json([
            'status' => true,
            'type' => $antrian->type,
            'prefix' => $config['prefix'] ?? 'A',
            'noantrian' => $antrian->noantrian,
            'loket' => $loketTerkini, //  HARUS DARI SETTINGS, bukan dari $antrian->loket
    ...
    private function generateAudioSequence($type, $noantrian, $loket)
    {
        ...
        // Split multi-character prefix jadi per huruf
        ...
        // PENTING: Konversi $loket (parameter yang dikirim) ke audio
